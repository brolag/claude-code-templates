...
metadata:
  short-description: Turn Notion specs into implementation plans, tasks, and progress tracking; use when implementing PRD
  category: utilities
...
```
$notion-spec-to-implementation [arguments]
```
