...
metadata:
  short-description: Analyzes meeting transcripts and recordings to uncover behavioral patterns, communication insights, 
  category: utilities
...
```
$meeting-insights-analyzer [arguments]
```
