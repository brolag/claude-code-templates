...
metadata:
  short-description: Capture conversations and decisions into structured Notion pages; use when turning chats/notes into 
  category: utilities
...
```
$notion-knowledge-capture [arguments]
```
