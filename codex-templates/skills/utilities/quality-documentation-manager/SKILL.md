...
metadata:
  short-description: Senior Quality Documentation Manager for comprehensive documentation control and regulatory document
  category: utilities
...
```
$quality-documentation-manager [arguments]
```
