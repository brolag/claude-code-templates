...
metadata:
  short-description: Multi-channel demand generation, paid media optimization, SEO strategy, and partnership programs for
  category: utilities
...
```
$marketing-demand-acquisition [arguments]
```
