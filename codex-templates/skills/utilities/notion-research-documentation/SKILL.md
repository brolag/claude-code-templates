...
metadata:
  short-description: Research across Notion and synthesize into structured documentation; use when gathering info from mu
  category: utilities
...
```
$notion-research-documentation [arguments]
```
