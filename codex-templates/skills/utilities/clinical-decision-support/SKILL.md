...
metadata:
  short-description: "Generate professional clinical decision support (CDS) documents for pharmaceutical and clinical res
  category: utilities
...
```
$clinical-decision-support [arguments]
```
