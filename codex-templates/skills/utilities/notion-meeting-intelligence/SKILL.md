...
metadata:
  short-description: Prepare meeting materials with Notion context and Codex research; use when gathering context, drafti
  category: utilities
...
```
$notion-meeting-intelligence [arguments]
```
