...
metadata:
  short-description: Senior FDA consultant and specialist for medical device companies including HIPAA compliance and req
  category: utilities
...
```
$fda-consultant-specialist [arguments]
```
