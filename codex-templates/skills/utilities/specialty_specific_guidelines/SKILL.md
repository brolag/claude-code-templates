...
description: specialty_specific_guidelines skill
metadata:
  short-description: specialty_specific_guidelines skill
  category: utilities
  source: claude-code-templates
---

# Specialty_Specific_Guidelines
...
```
$specialty_specific_guidelines [arguments]
```
