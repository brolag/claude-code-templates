...
description: data_visualization_slides skill
metadata:
  short-description: data_visualization_slides skill
  category: utilities
  source: claude-code-templates
---

# Data_Visualization_Slides
...
```
$data_visualization_slides [arguments]
```
