...
description: nih_specific_aims_template skill
metadata:
  short-description: nih_specific_aims_template skill
  category: utilities
  source: claude-code-templates
---

# Nih_Specific_Aims_Template
...
```
$nih_specific_aims_template [arguments]
```
