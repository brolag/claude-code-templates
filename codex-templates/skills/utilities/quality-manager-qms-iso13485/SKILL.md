...
metadata:
  short-description: ISO 13485 Quality Management System specialist for medical device companies. Provides QMS implementa
  category: utilities
...
```
$quality-manager-qms-iso13485 [arguments]
```
