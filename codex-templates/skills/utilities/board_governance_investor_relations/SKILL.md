...
description: board_governance_investor_relations skill
metadata:
  short-description: board_governance_investor_relations skill
  category: utilities
...
```
$board_governance_investor_relations [arguments]
```
