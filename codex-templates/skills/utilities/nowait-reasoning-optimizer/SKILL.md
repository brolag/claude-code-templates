...
metadata:
  short-description: Implements the NOWAIT technique for efficient reasoning in R1-style LLMs. Use when optimizing infere
  category: utilities
...
```
$nowait-reasoning-optimizer [arguments]
```
