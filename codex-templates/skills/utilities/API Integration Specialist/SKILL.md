...
metadata:
  short-description: Expert in integrating third-party APIs with proper authentication, error handling, rate limiting, an
  category: utilities
...
```
$API Integration Specialist [arguments]
```
