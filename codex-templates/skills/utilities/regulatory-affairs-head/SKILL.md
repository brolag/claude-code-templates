...
metadata:
  short-description: Senior Regulatory Affairs Manager expertise for HealthTech and MedTech companies. Provides strategic
  category: utilities
...
```
$regulatory-affairs-head [arguments]
```
