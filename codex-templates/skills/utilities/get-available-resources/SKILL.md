...
metadata:
  short-description: This skill should be used at the start of any computationally intensive scientific task to detect an
  category: utilities
...
```
$get-available-resources [arguments]
```
