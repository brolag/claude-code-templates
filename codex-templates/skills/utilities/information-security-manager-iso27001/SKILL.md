...
metadata:
  short-description: Senior Information Security Manager specializing in ISO 27001 and ISO 27002 implementation for Healt
  category: utilities
...
```
$information-security-manager-iso27001 [arguments]
```
