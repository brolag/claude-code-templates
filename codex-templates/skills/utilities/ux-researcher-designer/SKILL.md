...
metadata:
  short-description: UX research and design toolkit for Senior UX Designer/Researcher including data-driven persona gener
  category: utilities
...
```
$ux-researcher-designer [arguments]
```
