...
metadata:
  short-description: Generates creative domain name ideas for your project and checks availability across multiple TLDs (
  category: utilities
...
```
$domain-name-brainstormer [arguments]
```
