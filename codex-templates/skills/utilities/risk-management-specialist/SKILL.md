...
metadata:
  short-description: Senior Risk Management specialist for medical device companies implementing ISO 14971 risk managemen
  category: utilities
...
```
$risk-management-specialist [arguments]
```
