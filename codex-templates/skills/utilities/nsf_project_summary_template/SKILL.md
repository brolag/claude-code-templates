...
description: nsf_project_summary_template skill
metadata:
  short-description: nsf_project_summary_template skill
  category: utilities
  source: claude-code-templates
---

# Nsf_Project_Summary_Template
...
```
$nsf_project_summary_template [arguments]
```
