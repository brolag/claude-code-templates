...
metadata:
  short-description: "Access NIH Metabolomics Workbench via REST API (4,200+ studies). Query metabolites, RefMet nomencla
  category: utilities
...
```
$metabolomics-workbench-database [arguments]
```
