---
name: radiology_report_template
description: radiology_report_template skill
metadata:
  short-description: radiology_report_template skill
  category: utilities
...
```
$radiology_report_template [arguments]
```
