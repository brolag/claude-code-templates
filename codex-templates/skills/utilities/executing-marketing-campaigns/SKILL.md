...
metadata:
  short-description: Plans, creates, and optimizes marketing campaigns including content strategy, social media, email, a
  category: utilities
...
```
$executing-marketing-campaigns [arguments]
```
