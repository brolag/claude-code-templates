...
metadata:
  short-description: Analyzes your recent Claude Code chat history to identify coding patterns, development gaps, and are
  category: utilities
...
```
$developer-growth-analysis [arguments]
```
