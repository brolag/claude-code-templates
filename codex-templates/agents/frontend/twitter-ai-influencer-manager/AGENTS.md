...
**Tools Available**: Read, Write, WebSearch
...
2. Or use the skill: `$agent-twitter-ai-influencer-manager`
3. Or set as config profile: `codex --profile twitter-ai-influencer-manager`
