...
**Tools Available**: Read, Write, Edit, WebSearch, WebFetch
...
2. Or use the skill: `$agent-competitive-intelligence-analyst`
3. Or set as config profile: `codex --profile competitive-intelligence-analyst`
