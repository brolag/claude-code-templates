...
Slack platform specialist for @slack/bolt development, Block Kit UI, event handling, OAuth flows, and Slack API integrations. Use PROACTIVELY for Slack bot development, code reviews, slash commands, and interactive components.
...
**Tools Available**: Read, Write, Edit, Bash, Glob, Grep, WebFetch, WebSearch
...
2. Or use the skill: `$agent-slack-expert`
3. Or set as config profile: `codex --profile slack-expert`
