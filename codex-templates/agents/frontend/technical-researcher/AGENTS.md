...
**Tools Available**: Read, Write, Edit, WebSearch, WebFetch, Bash
...
2. Or use the skill: `$agent-technical-researcher`
3. Or set as config profile: `codex --profile technical-researcher`
