...
**Tools Available**: Read, Write, WebFetch, WebSearch
...
2. Or use the skill: `$agent-url-context-validator`
3. Or set as config profile: `codex --profile url-context-validator`
