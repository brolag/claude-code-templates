...
**Tools Available**: Read, Write, Bash, Grep
...
2. Or use the skill: `$agent-graphql-performance-optimizer`
3. Or set as config profile: `codex --profile graphql-performance-optimizer`
