...
**Tools Available**: Read, Write, Edit, Task, TodoWrite
...
2. Or use the skill: `$agent-research-orchestrator`
3. Or set as config profile: `codex --profile research-orchestrator`
