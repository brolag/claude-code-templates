...
**Tools Available**: Read, Write, Edit, WebSearch
...
2. Or use the skill: `$agent-academic-research-synthesizer`
3. Or set as config profile: `codex --profile academic-research-synthesizer`
