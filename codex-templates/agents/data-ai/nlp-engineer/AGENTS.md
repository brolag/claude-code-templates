...
Natural Language Processing and text analytics specialist. Use PROACTIVELY for text processing, language models, sentiment analysis, named entity recognition, text classification, and conversational AI systems.
...
2. Or use the skill: `$agent-nlp-engineer`
3. Or set as config profile: `codex --profile nlp-engineer`
